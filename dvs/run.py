...
for trial in range(config['num_trials']):
    ...
    print(f"=======Trial: {trial}, Batch: {config['batch_size']}, beta: {config['beta']:.3f}, thr_final1: {config['thr_final1']:.2f}, thr_final2: {config['thr_final2']:.2f}, thr_final3: {config['thr_final3']:.2f}, slope: {config['slope']}, lr: {config['lr']:.3e}======")
